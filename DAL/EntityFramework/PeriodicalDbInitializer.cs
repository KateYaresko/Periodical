        ...
        protected override void Seed(PeriodicalContext db)
        {
            ...
            var ChameleonArticle = new Article
            {
                ...
                Text = @"Color-changing panther chameleons are among the most disco-ready lizards, courtesy of tiny, built-in crystals that rapidly create multicolored hues.
                        Embedded in the panther chameleon’s skin are not one, but two layers of crystal-containing cells, scientists at Switzerland’s University of Geneva report Tuesday in Nature Communications. Stretching or relaxing the cells helps the animals rapidly change color by changing the color of reflected light.
                        Only adult male panther chameleons have a fully developed upper layer of the cells, called iridophores, which they use to put on multihued shows for mating. When the crystals are close together, such as when the animal is relaxed, they reflect blue light. When they are combined with yellow pigments in the chameleon skin, the animal appears green. Stretching the cells and moving the crystals farther apart produces colors ranging from yellow to red.
            ...
            var ButterflyArticle = new Article
            {
                ...
                Text = @"Ask a social butterfly where she got that great dress, and she'll say, 'This old thing?' and then tell you its entire history.
                        ...
                        Our Weird Animal Question of the Week comes to us from National Geographic's own Angie McPherson, a volunteer at the Smithsonian Butterfly Garden in Washington, D.C.'s National Museum of Natural History. She asked, 'Why does the paper kite butterfly create a gold chrysalis?'
            ...
            var FishArticle = new Article
            {
                ...
                Text = @"Few animals have ignored the warning “use it or lose it” as spectacularly as the Mexican blind cavefish, which no longer has eyes.
                        Now scientists may have solved the riddle of why the fish lost their eyes in the dark.
                        With food so scarce in caves, the animals have to save their energy—and being sightless gives them a major boost, according to a team from Sweden's Lund University.
            ...
            var SunsetArticle = new Article
            {
                ...
                Text = @"Fish, hippopotamuses, and other animals produce chemicals that protect them from the sun's rays.
                        ...
                        The gadusol produced by zebrafish, a highly studied lab species, may even help scientists create a better sunscreen for people.
            ...
            var DangerArticle = new Article
            {
                ...
                Text = @"After a month of rockfalls, climbers are reminded that rock solid sometimes isn’t solid enough.
                        ...
                        According to Stock, what he would’ve heard was a slab of rock avalanching off the Regular Northwest Face, a 2,200-foot climbing route on Half Dome, Yosemite’s iconic granite peak. It likely happened on July 3, but it wasn’t reported until two days later, when climbers Andrew Brodhead and Scott Sinner attempted to scale the route, but turned back upon realizing that a huge swath of rock had fallen, leaving behind a section of sheer, vertical terrain that appeared unclimbable.
                        The slab of rock that fell was shaped like an isosceles triangle: 200 feet tall and 100 feet wide. It’s estimated to have been between 5 and 15 feet thick, and it likely weighed about five million pounds.
            ...
            var SeaArticle = new Article
            {
                ...
                Text = @"New research predicts a stunning meltoff of the Antarctic Ice Sheet if all of the world's accessible fossil fuel is burned.
                        ...
                        Sea levels stand to rise by a staggering 164 feet or more if the world goes for broke on fossil fuels, burning all its attainable resources. That's because the Antarctic Ice Sheet would melt entirely from the warming caused by those emissions, concludes a study published Friday in Science Advances. The researchers say their paper offers the first long-term look at how carbon dioxide emissions from oil, coal, and natural gas would affect the entire ice sheet.
            ...
            var ClimateArticle = new Article
            {
                ...
                Text = @"The U.S. will likely expand “cap and trade” to curb emissions. Several countries are trying this, but their mixed results may offer lessons in what not to do.
                        ...
                        The rule even says: “It is reasonable to anticipate that a virtually nationwide emissions trading market for compliance will emerge.”",
            ...
            var LaboratoryArticle = new Article
            {
                ...
                Text = @"$102 million biosecurity facility will open in 2015.
                        ...
                        The Central Reference Laboratory will open in 2015 and offer high-security lab space for scientists to study dangerous diseases and provide early warning of potential outbreaks.
                        The facility, funded by the United States Defense Threat Reduction Agency and the Nunn-Lugar Cooperative Threat Reduction Program, will have the additional benefit of giving stable employment to scientists who might otherwise be tempted to sell their high-level and potentially destructive knowledge to hostile groups, said Lt. Col. Charles Carlton, director of the DTRA offices in Kazakhstan.
                        ...
                        Yersinia pestis, the bacterium that causes bubonic, pneumonic, and septicemic plagues, is spread by rats and fleas. The disease emerged only about ten thousand years ago but has claimed hundreds of millions of lives during its brief time on Earth, including roughly one-third of the entire population of Europe in the 14th century, when the infection was called the Black Death.
                        ...
                        Earlier this year, a study published in Infection, Genetics, and Evolution concluded that there's still a serious risk of plague originating in developing countries.
                        ...
                        'The hope is that this will become a regional center for scientists from throughout Central Asia and the Caucuses to exchange information and conduct training and research,' he said, adding that the CRL will act as a hub for a large network of Kazakh diagnostic laboratories.
            ...
            var BatArticle = new Article
            {
                ...
                Text = @"Being tiny and moving slowly are key for animals who live on the flip side.
                        ...
                        The average adult human carries about 2 gallons of blood, according to the American Red Cross. That’s a lot of liquid suddenly rushing to your head if you were to hang upside down—hence the discomfort.
                        By comparison, bats are lightweights. The tiniest bat in the world, Kitti’s hog-nosed bat, also known as the bumblebee bat, weighs in at 0.07 ounces. Even the two largest known bat species, Australia’s black flying fox and the Philippines' golden-crowned flying fox, weigh only up to 2.5 pounds.
            ...
            var WhalesArticle = new Article
            {
                ...
                Text = @"These deep-diving whales off the Galápagos have their own dialects, a sign that they have a culture.
                        ...
                        The ocean around the Galápagos Islands hosts thousands of female sperm whales and their calves that have organized into clans with their own dialects. How these clans form has been something of a mystery until now.
            ...
            var userBlocked = new User { FirstName = "Vasiliy", LastName = "Vasichkin", Email = "user_blocked@gmail.com", Password = "123456", Role = roleUser, Cash = 0, IsBlocked = true };
            var users = new List<User> { userAdmin, userEditor, userDefault, userBlocked };
